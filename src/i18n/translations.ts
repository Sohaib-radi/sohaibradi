    ...
    items: [
      {
        ...
        duration: "Modules 0 to 6",
        level: "Beginners to intermediate developers",
        body: "Build production-grade, multi-tenant AI platforms with async task streaming, Telegram Mini Apps, and enterprise CRM integrations.",
        program: [
    ...
    items: [
      {
        ...
        duration: "الوحدات 0 إلى 6",
        level: "من المبتدئين إلى المطورين المتوسطين",
        body: "بناء منصات ذكاء اصطناعي قابلة للتوسع ومتعددة المستأجرين (Multi-tenant) بمستوى إنتاجي مع البث غير المتزامن للمهام (Async task streaming)، تطبيقات تلغرام المصغرة (Telegram Mini Apps - TMA)، وتكاملات نظم إدارة علاقات العملاء (CRM) للمؤسسات.",
        program: [
